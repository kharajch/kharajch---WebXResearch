...
export const metadata = {
  ...
  description:
    "Summarize any webpage instantly with AI. Paste a URL and get comprehensive research summaries, key insights, and follow-up answers powered by Google Gemini.",
  keywords: [
    "web research",
    "AI summarizer",
    "webpage summary",
